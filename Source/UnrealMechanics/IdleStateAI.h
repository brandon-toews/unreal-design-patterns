...
#include "IdleStateAI.generated.h"

//Idle state class that executes the enemy character's idle state behavior
UCLASS(Blueprintable, BlueprintType)
class UNREALMECHANICS_API UIdleStateAI : public UBaseStateAI
{
	GENERATED_BODY()
